...
func readConfigValue[T any](h *Handler, read func(*config.Config) T) (value T) {
	if h == nil || read == nil {
		return value
	}
	h.mu.RLock()
...
func (h *Handler) GetLatestVersion(c *gin.Context) {
	...
	proxyURL := strings.TrimSpace(readConfigValue(h, func(cfg *config.Config) string { return cfg.ProxyURL }))
	if proxyURL != "" {
...
func (h *Handler) GetDebug(c *gin.Context) {
	c.JSON(200, gin.H{"debug": readConfigValue(h, func(cfg *config.Config) bool { return cfg.Debug })})
}
func (h *Handler) PutDebug(c *gin.Context) { h.updateBoolField(c, func(v bool) { h.cfg.Debug = v }) }

// UsageStatisticsEnabled
func (h *Handler) GetUsageStatisticsEnabled(c *gin.Context) {
	value := readConfigValue(h, func(cfg *config.Config) bool { return cfg.UsageStatisticsEnabled })
	c.JSON(200, gin.H{"usage-statistics-enabled": value})
}
...
func (h *Handler) GetUsageDetailRetentionLimit(c *gin.Context) {
	value := readConfigValue(h, func(cfg *config.Config) int { return cfg.UsageDetailRetentionLimit })
	c.JSON(200, gin.H{"usage-detail-retention-limit": value})
}
...
func (h *Handler) GetLoggingToFile(c *gin.Context) {
	value := readConfigValue(h, func(cfg *config.Config) bool { return cfg.LoggingToFile })
	c.JSON(200, gin.H{"logging-to-file": value})
}
...
func (h *Handler) GetLogsMaxTotalSizeMB(c *gin.Context) {
	value := readConfigValue(h, func(cfg *config.Config) int { return cfg.LogsMaxTotalSizeMB })
...
func (h *Handler) GetErrorLogsMaxFiles(c *gin.Context) {
	value := readConfigValue(h, func(cfg *config.Config) int { return cfg.ErrorLogsMaxFiles })
...
func (h *Handler) GetRequestLog(c *gin.Context) {
	c.JSON(200, gin.H{"request-log": readConfigValue(h, func(cfg *config.Config) bool { return cfg.RequestLog })})
}
...
func (h *Handler) GetWebsocketAuth(c *gin.Context) {
	c.JSON(200, gin.H{"ws-auth": readConfigValue(h, func(cfg *config.Config) bool { return cfg.WebsocketAuth })})
}
...
func (h *Handler) GetRequestRetry(c *gin.Context) {
	c.JSON(200, gin.H{"request-retry": readConfigValue(h, func(cfg *config.Config) int { return cfg.RequestRetry })})
}
...
func (h *Handler) GetMaxRetryInterval(c *gin.Context) {
	c.JSON(200, gin.H{"max-retry-interval": readConfigValue(h, func(cfg *config.Config) int { return cfg.MaxRetryInterval })})
}
...
func (h *Handler) GetForceModelPrefix(c *gin.Context) {
	c.JSON(200, gin.H{"force-model-prefix": readConfigValue(h, func(cfg *config.Config) bool { return cfg.ForceModelPrefix })})
}
...
func normalizeRoutingStrategy(strategy string) (string, bool) {
	...
	case strings.EqualFold(strategy, "round-robin"):
		return "round-robin", true
	case strings.EqualFold(strategy, "roundrobin"):
		return "round-robin", true
	case strings.EqualFold(strategy, "rr"):
		return "round-robin", true
...
func (h *Handler) GetRoutingStrategy(c *gin.Context) {
	raw := readConfigValue(h, func(cfg *config.Config) string { return cfg.Routing.Strategy })
...
func (h *Handler) GetProxyURL(c *gin.Context) {
	c.JSON(200, gin.H{"proxy-url": readConfigValue(h, func(cfg *config.Config) string { return cfg.ProxyURL })})
}
