...
func TestCodexWebsocketsExecuteStreamHandshakeDebugDisconnectsBeforeRequestMessage(t *testing.T) {
	var (
		upgrader     = websocket.Upgrader{}
	...
	if err == nil {
		...
		t.Fatal("ExecuteStream() error = nil, want handshake debug error")
	}
	if result != nil {
