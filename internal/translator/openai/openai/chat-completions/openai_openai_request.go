// Package openai provides request translation functionality for OpenAI API compatibility.
// It normalizes OpenAI Chat Completions requests using sjson only.
...
// into a request JSON with the configured upstream model name.
//
// Parameters:
