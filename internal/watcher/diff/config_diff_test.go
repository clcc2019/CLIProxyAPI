...
func TestBuildConfigChangeDetails(t *testing.T) {
	...
	expectContains(t, details, "remote-management.panel-github-tag: v1.0.0 -> v2.0.0")
...
func TestBuildConfigChangeDetails_FlagsAndKeys(t *testing.T) {
	oldCfg := &config.Config{
		...
		RemoteManagement:       config.RemoteManagement{DisableControlPanel: false, PanelGitHubRepository: "old/repo", PanelGitHubTag: "v1.0.0", SecretKey: "keep"},
		SDKConfig: sdkconfig.SDKConfig{
			RequestLog:                            false,
...
func TestBuildConfigChangeDetails_AllBranches(t *testing.T) {
	...
	expectContains(t, changes, "remote-management.panel-github-tag: v1.0.0 -> v2.0.0")
