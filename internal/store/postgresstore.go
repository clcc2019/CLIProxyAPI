...
// valueAsString / labelFor / normalizeAuthID are shared with other backends
// and now live in stub_common.go (untagged) so they're available to all
// backends regardless of build tags.
