...
`)
	...
	if cfg.CodexHeaderDefaults.IncludeTimingMetrics == nil || !*cfg.CodexHeaderDefaults.IncludeTimingMetrics {
		t.Fatalf("IncludeTimingMetrics = %v, want true", cfg.CodexHeaderDefaults.IncludeTimingMetrics)
	}
}
