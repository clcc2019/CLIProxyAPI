...
var zhStrings = map[string]string{
	...
	"status_active":                  "活跃",
	"status_disabled":                "已停用",
	"auth_plus_one_month_free":       "免费 Plus 一个月",
	"auth_plus_one_month_eligible":   "可领取",
	"auth_plus_one_month_ineligible": "不符合条件",
	"auth_plus_one_month_badge":      "可免费试用 Plus 1 月",
...
var enStrings = map[string]string{
	...
	"auth_plus_one_month_free":       "One-month Plus",
	"auth_plus_one_month_eligible":   "Eligible",
	"auth_plus_one_month_ineligible": "Not eligible",
	"auth_plus_one_month_badge":      "1-mo Plus free",
