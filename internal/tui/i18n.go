...
var zhStrings = map[string]string{
	...
	"oauth_success":      "认证成功! Auth Files 列表已自动刷新。",
	"oauth_completed":    "认证流程已完成。",
	"oauth_failed":       "认证失败",
	"oauth_timeout":      "OAuth 流程超时",
	"oauth_press_esc":    "  按 [Esc] 取消",
	"oauth_auth_url":     "  授权链接:",
	"oauth_device_code":  "  设备码:",
	"oauth_device_hint":  "  在浏览器中打开上述链接并输入设备码；此终端会自动等待授权完成。",
...
var enStrings = map[string]string{
	...
	"oauth_success":      "Authentication successful! The Auth Files list has been refreshed.",
	...
	"oauth_device_hint":  "  Open the URL above and enter the device code; this terminal will wait for authorization.",
